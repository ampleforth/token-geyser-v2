...
const geyserList: AppGeysersList = {
  [Network.Mainnet]: [
    {
      name: 'Crystal V1 (Charm WETH/WAMPL)',
    ...
    {
      name: 'Steamboat V1 (BillBroker USDC/SPOT)',
    ...
    {
      name: 'Great Geyser V1 (Charm USDC/SPOT)',
    ...
    {
      name: 'Beehive V7 (UniswapV2 ETH-AMPL)',
    ...
    {
      name: 'Fly V2 (ArrakisV1 USDC/SPOT)',
    ...
    {
      name: 'Beehive V6 (UniswapV2 ETH-AMPL)',
    ...
    {
      name: 'Fly V1 (ArrakisV1 USDC/SPOT)',
    ...
    {
      name: 'Beehive V5 (UniswapV2 ETH-AMPL)',
    ...
    {
      name: 'Trinity V3 (BalancerV2 WBTC-WETH-WAMPL)',
    ...
    {
      name: 'Splendid Pilot (AAVEV2 aAMPL)',
    ...
    {
      name: 'Beehive V4 (UniswapV2 ETH-AMPL)',
    ...
    {
      name: 'Trinity V2 (BalancerV1 BTC-ETH-AMPL)',
    ...
    {
      name: 'Old Faithful V2 (BalancerV1 AMPL-USDC)',
