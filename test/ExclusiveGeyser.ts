...
// Replicated Geyser.ts to validate identical behavior
// Additionally added specs for exclusive staking
describe('ExclusiveGeyser', function () {
  ...
  describe('initialize', function () {
    describe('when rewardScaling.floor > rewardScaling.ceiling', function () {
      it('should fail', async function () {
        ...
        await expect(deployGeyser(args, 'ExclusiveGeyser')).to.be.reverted
      })
    })
    ...
    describe('when parameters are valid', function () {
      it('should set contract variables', async function () {
        ...
        const geyser = await deployGeyser(args, 'ExclusiveGeyser')
  ...
  describe('admin functions', function () {
    ...
    beforeEach(async function () {
      ...
      geyser = await deployGeyser(args, 'ExclusiveGeyser')
